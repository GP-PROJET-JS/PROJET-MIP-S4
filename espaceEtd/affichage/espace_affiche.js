...
window.onload = () => {
  if (!examLien) {
    alert("Aucun examen selectionne.");
...
function showQuestion() {
  ...
  if (question.audio_url) {
    ...
    audio.style.justifySelf = "centre";
    audio.controls = true;
  ...
  if (question.video_url) {
    ...
    video.style.justifySelf = "centre";
  ...
  if (question.type === "qcm") {
    ...
    input.type = "text";
    input.placeholder = "Votre reponse ici...";
...
function submitExam() {
  ...
  document.querySelector("h1").innerHTML = "Exame Terminer";
  document.getElementById("exam-container").remove();
  const scorep = document.getElementById("score")
  scorep.textContent = `Votre score : ${scoreFinal}/100`;
  scorep.style.padding = "30px";
  scorep.style.border = "solid";
  scorep.style.borderRadius = "50%";

  document.getElementById("timer").innerHTML = "retour";
  const terminer = document.getElementById("timer");
  terminer.style.padding = "10px 25px ";
  terminer.addEventListener("mouseover", () => {
    terminer.style.cursor = "pointer";
    terminer.style.transform = "scale(1.05)";
    // terminer.style.background = "background: linear-gradient(90deg, #3579b4, #4888c0);";
  })
  terminer.addEventListener("mouseout", () => {
    terminer.style.transform = "scale(1)";
    // terminer.style.background = "background: linear-gradient(90deg, #3579b4, #4888c0);";
  })
  terminer.addEventListener("click", () => {
    window.location.href = "../Espace_Etd.html"
  })
